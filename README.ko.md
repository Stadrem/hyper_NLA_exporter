...
* ✅ **안전한 내보내기**: 중복/빈 클립 이름, 2프레임 미만 클립, 잘못된 마커, 누락된 Action Slot과 F-Curve, 범위 안의 키 유무, 선택에서 빠진 스킨드 메시를 사전에 확인합니다. 기존 NLA 트랙은 Quick Export 동안 임시 격리하고 완료 후 원래 상태로 복원합니다.
...
3. **Blender 5.1 Layered Action 애니메이션 구조**:
